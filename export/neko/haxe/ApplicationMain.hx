...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Project Game", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Project Game", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Project Game";
		app.meta["name"] = "Project Game";
